        ...
        var PersianDateClass = (function () {
          function PersianDateClass(input) {
            ...
            if (helpers.isUndefined(input)) {
              ...
              this.gDate =
                this.algorithms.persianArrayToGregorianDate(arrayInput);
            ...
            [
              ...
              },
              {
                ...
                value: function format(inputString) {
                  var self = this,
                    formattingTokens =
                      /([[^[]*])|(\\)?(Mo|MM?M?M?|Do|DD?D?D?|ddddd|dddd?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|zz?|ZZ?|X|LT|ll?l?l?|LL?L?L?)/g,
                    info = {
                      year: self.year(),
                      month: self.month(),
                      hour: self.hours(),
              ...
              },
              {
                ...
                value: function date(input) {
                  if (input || input === 0) {
                    var pDateArray = this.algorithms.getPersianArrayFromPDate(
                      this.pDate
                    );
                    pDateArray[2] = input;
                    this.gDate =
                      this.algorithms.persianArrayToGregorianDate(pDateArray);
                    this._updatePDate();
                    return this;
                  } else {
              ...
              },
              {
                ...
                value: function getFirstWeekDayOfMonth(year, month) {
                  var dateArray = this.algorithms.calcPersian(year, month, 1),
                    pdate = this.algorithms.calcGregorian(
                      dateArray[0],
                      dateArray[1],
                      dateArray[2]
                    );
          ...
          _createClass(Algorithms, [
            ...
            },
            {
              ...
              value: function jdToGregorian(jd) {
                ...
                var yearday = wjd - this.gregorianToJd(year, 1, 1),
                  leapadj =
                    wjd < this.gregorianToJd(year, 3, 1)
                      ? 0
                      : this.isLeapGregorian(year)
                      ? 1
                      : 2,
            ...
            },
            {
              ...
              value: function calcGregorian(year, month, day) {
                //  Update Julian day
                var j =
                    this.gregorianToJd(year, month + 1, day) +
