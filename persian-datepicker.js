...
(function webpackUniversalModuleDefinition(root, factory) {
   ...
   * <div id="plotId" class="datepicker-plot-area datepicker-plot-area-inline-view">
   ...
   {{#.}}
    {{#enabled}}
   <td data-unix="{{dataUnix}}" ><span  class="{{#otherMonth}}other-month{{/otherMonth}} {{#select}}select{{/select}}">{{title}}</span></td>
   {{/enabled}}
   {{^enabled}}
   ...
   {{#month.list}}
   {{#enabled}}
   <div data-month="{{dataMonth}}" class="month-item {{#select}}select{{/select}}">{{title}}</small></div>
   {{/enabled}}
   {{^enabled}}
   <div data-month="{{dataMonth}}" class="month-item month-item-disable {{#select}}select{{/select}}">{{title}}</small></div>
   {{/enabled}}
   {{/month.list}}
   </div>
   {{/month.viewMode}}
