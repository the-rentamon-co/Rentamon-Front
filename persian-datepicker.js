              ...
              value: function _attachInputElementEvents() {
                ...
                if (this.model.state.ui.isInline === false) {
                  $(document).on("click", function (e) {
                    if (
                      !$(e.target).closest(
                        ".datepicker-plot-area, .datepicker-plot-area > *, .pwt-datepicker-input-element"
                      ).length
                    ) {
              ...
              value: function liveAttach() {
                ...
                if (this.model.options.navigator.scroll.enabled) {
                  ...
                  if (this.model.options.timePicker.enabled) {
                    var timePlot = $(
                      "#" + that.model.view.id + " .datepicker-time-view"
                    )[0];
                    Hamster(timePlot).wheel(function (
                      event,
                      delta,
                      deltaX,
                      deltaY
                      ...
                      var key = $target.data("time-key")
                        ...
                        : $target.parents("[data-time-key]").data("time-key");
                      if (delta > 0) {
                        that.timeUp(key);
                      } else {
                        that.timeDown(key);
              ...
              value: function timeUp(timekey) {
                ...
                if (timekey == "meridiem") {
                  ...
                  if (this.model.state.view.meridiem == "PM") {
                    t = new persianDate(this.model.state.selected.unixDate)
                      .add("hour", step)
                      .valueOf();
                  } else {
                    t = new persianDate(this.model.state.selected.unixDate)
          ...
          _createClass(View, [
                ...
                if (this.model.options.position === "auto") {
                  ...
                  this.$container.css({
                    top:
                      ...
                      "px",
                    left:
                      this.model.options.position[1] + inputPosition.top + "px",
                  });
                }
              },
            ...
            },
            {
              ...
              value: function _getMonthViewModel() {
                ...
                try {
                  for (
                    var _iterator2 =
                        ClassDateRange.monthRange[Symbol.iterator](),
                      _step2;
                    ...
                    monthModel.push({
                      ...
                      selected: DateUtil.isSameMonth(
                        this.model.state.selected.dateObject,
                        new persianDate([
              ...
              value: function checkDayAccess(unixtimespan) {
                ...
                if (self.model.state.filetredDate) {
                  if (self.minDate && self.maxDate) {
                    self.minDate = new persianDate(self.minDate)
                      .startOf("day")
                      .valueOf();
                    self.maxDate = new persianDate(self.maxDate)
                      .endOf("day")
                      .valueOf();
                    if (
                      !(
                    ...
                    try {
                      for (
                        ...
                        if (rowIndex === 0 && dayIndex < firstWeekDayOfMonth) {
                          ...
                          calcedDate = pdate.subtract(
                            "days",
                            firstWeekDayOfMonth - dayIndex
                          );
                          otherMonth = true;
                        } else if (
                        ...
                        calcedDate.formatPersian =
                          this.model.options.persianDigit;
                        outputList[rowIndex].push({
                          title: calcedDate.format("DD"),
                          dataUnix: calcedDate.valueOf(),
                          selected: DateUtil.isSameDay(
                            calcedDate,
                            this.model.state.selected.dateObject
                          ),
                          today: DateUtil.isSameDay(
                            calcedDate,
                            new persianDate()
                          ),
            ...
            },
            {
              ...
              value: function _getTimeViewModel() {
                ...
                this.model.state.view.dateObject.formatPersian =
                  this.model.options.persianDigit;

                if (this.model.options.timePicker.meridiem.enabled) {
                  hourTitle = (
                    DateUtil.convert24hTo12(
                      this.model.state.view.hour,
                      this.model.state.view.meridiem
                    ) + ""
                  ).toPersianDigit();
                } else {
                  hourTitle = (
            ...
            },
            {
              ...
              value: function getViewModel(data) {
                return {
                  ...
                  cssClass: this.model.state.ui.isInline
